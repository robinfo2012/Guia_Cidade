<?php
require_once __DIR__ . "/../config_owner.php";// seu arquivo de conexão com $mysqli

// Dados do dono que você quer cadastrar
$username = 'robinfonet';        // usuário do dono
$password = 'eclesiac346@';        // senha do dono
$business_name = 'ICTELECOM'; // nome do negócio que ele será vinculado
